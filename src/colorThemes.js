...
export const pageColors = {
  ...
  // Use fully transparent hit areas to avoid any chance of dark tinting during
  // group opacity/scale compositing in Konva
  blackHitArea: colorThemes.transparent,
